...
const uri = "mongodb+srv://BookWiseDB:eswar10cgpa@mydatabase.seg2ukw.mongodb.net/?retryWrites=true&w=majority";
...
async function run() {
  try {
    ...
    //inserting a book to the db using post method
